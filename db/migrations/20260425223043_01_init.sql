...
CREATE TABLE auth_useroauth (
    id          INTEGER PRIMARY KEY AUTOINCREMENT,
    user_id     INTEGER NOT NULL UNIQUE REFERENCES auth_user(id),
    provider_id INTEGER NOT NULL UNIQUE,
    provider    TEXT    NOT NULL CHECK (provider IN ('overlord')),
    created_at  TEXT    NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
DROP TABLE IF EXISTS helpdesk_request_type;
DROP TABLE IF EXISTS helpdesk_request_category;
...
DROP TABLE IF EXISTS auth_useroauth;

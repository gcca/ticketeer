...
INSERT INTO helpdesk_setting
    (name, default_status_id, default_assigned_to_id, default_ticket_priority_id, assigned_status_id, system_profile_id, ticket_body_maxlength, ticket_activity_body_maxlength, ticket_due_delta, ticket_attachment_maxsize, ticket_activity_attachment_maxsize)
VALUES (
    'default',

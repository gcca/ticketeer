...
void TicketeerJsonConsoleSink::AppendJsonString(std::string_view value) {
...
void TicketeerJsonConsoleSink::AppendJsonField(
...
void TicketeerJsonConsoleSink::generate_json_message(
...
quill::LogLevel ParseLogLevel(const std::string &level) {
  if (level == "DEBUG")

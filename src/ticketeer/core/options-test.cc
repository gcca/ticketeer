...
using ticketeer::core::options::Init;
...
TEST(OptionsTest, ParsesLogLevel) {
  char prog[] = "ticketeer";
  char flag[] = "--log_level";
  char val[] = "DEBUG";
  char *argv[] = {prog, flag, val};
...
TEST(OptionsTest, ParsesAllOptions) {
  char prog[] = "ticketeer";
  char b_flag[] = "--bind";

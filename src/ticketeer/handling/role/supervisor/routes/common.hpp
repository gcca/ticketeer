...
[[nodiscard]] bool UpsertDefaultSetting(
    sqlite3 *db, const std::string &default_status_id,
    const std::string &default_assigned_to_id,
    const std::string &default_ticket_priority_id,
    const std::string &assigned_status_id, const std::string &system_profile_id,
    int ticket_body_maxlength, int ticket_activity_body_maxlength,
